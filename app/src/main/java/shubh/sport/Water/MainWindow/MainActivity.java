package shubh.sport.Water.MainWindow;
...
import shubh.sport.Water.Chart.ChartActivity;
import shubh.sport.Water.Database.DrinkDataSource;
import shubh.sport.Water.Dialogs.AddDialog;
import shubh.sport.Water.Settings.PrefsHelper;
import shubh.sport.Water.Settings.SettingsActivity;
import shubh.sport.Water.WaterDrankHistory.DateLogActivity;
import shubh.sport.Water.Water_Advice;
...
public class MainActivity extends Activity  implements View.OnClickListener {
    ...
    private void goToOutlineActivity() {
        Intent intent2 = new Intent(getApplicationContext(), Water_Advice.class);
