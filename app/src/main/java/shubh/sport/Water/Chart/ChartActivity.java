package shubh.sport.Water.Chart;
...
import shubh.sport.Water.Model.DateLog;
import shubh.sport.Water.Model.TimeLog;
...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dayBarChart = findViewById(R.id.day_chart);
        ...
        weekBarChart = findViewById(R.id.week_chart);
        ...
        mothBarChart = findViewById(R.id.month_chart);
